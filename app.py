...
def main():
    st.title("Face Generator App")
    """This Webapp demonstrates Face Generation of Images using TL-GAN and PG-GAN. 
    It also uses other things like sliders and many other options convert a general image of person 
    into something different which is unique and non-existing"""
    ...
    st.sidebar.write(
        """Playing with the sliders, we _can_ find **biases** that exist in this
        model.
        """
    )
    st.sidebar.write(
